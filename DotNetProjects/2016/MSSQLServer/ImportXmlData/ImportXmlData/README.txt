Please Create a database on SQL Server database

Execute SQL Files from SQL_Scripts folder. First All tables followed by all Stored Procedures

Then update the SQL ConnectionString in ImportXmlData.exe.config file and Xml File path for the provided xml file including the xml file name.
